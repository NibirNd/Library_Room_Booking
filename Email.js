...
function makeEmail(request) {
  return (
    ...
    request.dateString +
    "<br />" +
    formatTimeString(request.time) +
    "<br />" +
    formatTimeString(request.endTime) +
    "<br /></h3><br />" +
    '<a href="' +
    request.buttonLink +
    ...
    'Created with <span>&#10084;</span> by<a href="https://www.linkedin.com/in/dasnibir/"> Nibir Das </a><br />2a546573543a44</p></div></body></html>'
  );
}